...
class CashPaymentProduct1526SpecificInput(CashPaymentProductWithRedirectSpecificInputBase):
    ...
    def from_dictionary(self, dictionary):
        super(CashPaymentProduct1526SpecificInput, self).from_dictionary(dictionary)
        return self
