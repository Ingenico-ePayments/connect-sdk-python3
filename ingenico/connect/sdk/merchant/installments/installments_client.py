...
from ingenico.connect.sdk.domain.installments.installment_options_response import InstallmentOptionsResponse
...
class InstallmentsClient(ApiResource):
    ...
    def __init__(self, parent, path_context):
        ...
        """
        super(InstallmentsClient, self).__init__(parent, path_context)
    ...
    def get_installments_info(self, body, context=None):
        ...
        :param body:     :class:`ingenico.connect.sdk.domain.installments.get_installment_request.GetInstallmentRequest`
        :param context:  :class:`ingenico.connect.sdk.call_context.CallContext`
        :return: :class:`ingenico.connect.sdk.domain.installments.installment_options_response.InstallmentOptionsResponse`
